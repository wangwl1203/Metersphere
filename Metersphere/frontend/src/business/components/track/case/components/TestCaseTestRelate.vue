...
<!--      <ms-table-column width="200" show-overflow-tooltip="false"
        prop="num"
        :label="$t('test_track.case.case_num')">
      </ms-table-column>-->

      <el-table-column prop="num" :label="$t('test_track.case.case_num')" width="250">
<!--        <template slot-scope="scope">
          <el-tooltip
            ...
            effect="dark"
          >
            <div slot="content">{{scope.row.num}}</div>
            <div>{{scope.row.num}}</div>
          </el-tooltip>
        </template>-->
      </el-table-column>

      <ms-table-column width="400"
        prop="name"
  ...
  data() {
    return {
      ...
      typeMap: {
        ...
        automation: this.$t('api_test.home_page.failed_case_list.table_value.case_type.auto'),
