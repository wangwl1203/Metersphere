export default {
  ...
  custom_field: {
    ...
    issue_severity: '嚴重程度',
    issue_reporter: '報告人',
    issue_import: '是否修複引入缺陷',
    issue_design: '設計類缺陷類型',
    issue_demand: '需求缺陷類型',
    issue_priority: '優先級',
    issue_testType: '測試類型',
    issue_submitNum: '提交次數',
    issue_type: '缺陷類型',
    issue_introductionPhase: '引入階段',
    issue_discoveryPhase: '發現階段',
    issue_fixedVersion: '修複的版本',
    issue_module: '模塊',
    issue_affectsVersion: '影響版本',
    issue_belongTo: '缺陷歸屬',
    issue_escape: '是否單元測試逃逸',
    issue_introducePeople: '缺陷引入人',
    issue_operator: '經辦人',
    create: '創建字段',
    name: '自定義字段',
    system_field: '系統字段',
  ...
  test_track: {
    ...
    sync_add_api_load: '同步添加關聯的性能測試',
    next: '下一條',
    total_size: '共 {0} 條',
    related_requirements: '關聯需求',
    related_requirements_zenTao: '關聯Zentao需求',
    please_related_requirements: '請選擇要關聯的需求',
    please_select_plan: '請選擇要關聯的計劃',
    please_select_one_requirement: '請選擇1條要關聯的需求',
    ...
    plan: {
      ...
      execute_result: "執行結果",
      affects_version:"影響版本",
      input_affects_version: "請選擇影響版本",
      load_case: {
        case: "性能用例",
    ...
    issue: {
      ...
      platform_status: "缺陷狀態",
      issue_resource: "缺陷來源",
      create_issue: "創建缺陷",
      add_issue: "添加缺陷",
      add_Jira_issue: "添加Jira缺陷",
      issue_list: "缺陷列表",
      search_name: "根據標題搜索",
