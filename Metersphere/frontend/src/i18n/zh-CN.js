...
export default {
  ...
  custom_field: {
    ...
    issue_severity: '严重程度',
    issue_reporter: '报告人',
    issue_import: '是否修复引入缺陷',
    issue_design: '设计类缺陷类型',
    issue_demand: '需求缺陷类型',
    issue_priority: '优先级',
    issue_testType: '测试类型',
    issue_submitNum: '提交次数',
    issue_type: '缺陷类型',
    issue_introductionPhase: '引入阶段',
    issue_discoveryPhase: '发现阶段',
    issue_fixedVersion: '修复的版本',
    issue_module: '模块',
    issue_affectsVersion: '影响版本',
    issue_belongTo: '缺陷归属',
    issue_escape: '是否单元测试逃逸',
  ...
  test_track: {
    ...
    sync_add_api_load: '同步添加关联的性能测试',
    next: '下一条',
    total_size: '共 {0} 条',
    related_requirements: '关联需求',
    related_requirements_zenTao: '关联禅道需求',
    please_related_requirements: '请选择要关联的需求',
    please_select_one_requirement: '请选择1条要关联的需求',
    please_select_plan: '请选择要关联的计划',
    ...
    plan: {
      ...
      execute_result: "执行结果",
      affects_version:"影响版本",
      input_affects_version: "请选择影响版本",
      load_case: {
        case: "性能用例",
