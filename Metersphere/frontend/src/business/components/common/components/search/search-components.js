...
//测试用例 用例等级
export const TEST_CASE_PRIORITY = [{text: 'P0', value: 'P0'},  {text: 'P1', value: 'P1'},  {text: 'P2', value: 'P2'},  {text: 'P3', value: 'P3'},  {text: 'P4', value: 'P4'}]
export const TEST_CASE_PRIORITY_AGAIN = [{id: 'P0', label: 'P0'},  {id: 'P1', label: 'P1'},  {id: 'P2', label: 'P2'},  {id: 'P3', label: 'P3'},  {id: 'P4', label: 'P4'}]
