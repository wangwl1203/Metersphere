...
//        workspaceService.checkWorkspaceOwnerByOrgAdmin(workspaceId);
    ...
    @GetMapping("/list/resource/{groupId}/{type}/{workspaceId}")
    public WorkspaceResource listResource(@PathVariable String groupId, @PathVariable String type, @PathVariable String workspaceId) {
        return workspaceService.listResource(groupId, type, workspaceId);
    }
}
