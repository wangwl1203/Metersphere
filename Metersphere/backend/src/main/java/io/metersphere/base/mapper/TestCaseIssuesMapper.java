...
public interface TestCaseIssuesMapper {
    ...
    int deleteByPlanIdAndIssuesId(String planId,List<String> issuesIds);
    ...
    List<TestCaseIssues> getIssuesByCaseId(@Param("request") IssuesRequest issuesRequest);

    List<TestCaseIssues> getIssuesByPlanId(String planId);
}