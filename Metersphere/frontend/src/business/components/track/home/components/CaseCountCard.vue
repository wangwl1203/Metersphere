    ...
    <el-container>
      ...
      <el-main style="padding-left: 0px;padding-right: 0px;">
        <div style="width: 200px;margin:0 auto">
          ...
          <el-row align="center">
            <el-col :span="4" style="padding: 5px;border-right-style: solid;border-right-width: 1px;border-right-color: #ECEEF4;">
            ...
            <el-col :span="4" style="padding: 5px;">
              <div class="count-info-div" v-html="trackCountData.p4CountStr"></div>
            </el-col>
          </el-row>
