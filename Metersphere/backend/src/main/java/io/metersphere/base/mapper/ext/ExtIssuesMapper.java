...
public interface ExtIssuesMapper {
    ...
    List<IssuesDao> getIssuesLocal(@Param("request") IssuesRequest issuesRequest);

    List<IssuesDao> getNotRelateIssues(@Param("request") IssuesRequest request);

    Integer issueCountLocal(@Param("request") IssuesRequest request);
