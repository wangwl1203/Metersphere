...
public class WorkspaceService {
    ...
    public String getWorkSpaceNameById(String workspaceId){
        return workspaceMapper.getNameById(workspaceId);
    }
    ...
    public WorkspaceResource listResource(String groupId, String type, String workspaceIdReq) {
        Group group = groupMapper.selectByPrimaryKey(groupId);
        String workspaceId;
        if(workspaceIdReq.equals("global")){
            workspaceId = group.getScopeId();
        }else{
            workspaceId = workspaceIdReq;
        }
