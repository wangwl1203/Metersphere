  ...
  <div v-loading="result.loading">
    <el-card class="table-card">
      <template v-slot:header>
        <ms-table-header :create-permission="['SYSTEM_USER:READ+CREATE','WORKSPACE_USER:READ+CREATE']" :condition.sync="condition"
                         @search="initTableData" @create="create"
                         :create-tip="$t('member.create')" :title="$t('commons.member')">
          <template v-slot:button>
            <ms-table-button v-permission="['SYSTEM_USER:READ+CREATE','WORKSPACE_USER:READ+CREATE']" icon="el-icon-download"
                             :content="$t('commons.import_user')" @click="importUserDialogOpen"/>
            <ms-table-button v-permission="['SYSTEM_USER:READ+CREATE','WORKSPACE_USER:READ+CREATE']" icon="el-icon-circle-plus-outline"
                             :content="$t('commons.createUser')" @click="createUser"/>
          </template>
    ...
    <user-import ref="userImportDialog" from-fun="workSpace" @refreshAll="search"></user-import>
    <edit-user ref="editUser" from-fun="workSpace" true @refresh="search"/>
...
export default {
  ...
  components: {
    ...
    MsTableHeaderSelectPopover, UserCascader, ShowMoreBtn, UserImport, EditUser, MsTableButton
  },
  data() {
    return {
      result: {},
