export default {
  ...
  custom_field: {
    ...
    issue_testType: 'TestType',
    issue_submitNum: 'SubmitNum',
    issue_introductionPhase: 'Introduction phase',
    issue_discoveryPhase: 'Discovery phase',
    issue_fixedVersion: 'Fixed version',
    issue_module: 'Module',
    issue_affectsVersion: 'Affects version',
    issue_belongTo: 'Belong to',
    issue_escape: 'Escape',
    issue_introducePeople: 'Introduce people',
  ...
  test_track: {
    ...
    sync_add_api_load: 'Synchronously add load tests',
    next: 'Next',
    total_size: 'Total {0}',
    related_requirements: 'Related requirements',
    related_requirements_zenTao: 'Related zenTao requirements',
    please_related_requirements: 'Please select the requirements to associate',
    please_select_plan: 'Please select the plan to associate',
    please_select_one_requirement: 'Please select the requirement to associate',
    ...
    case: {
      ...
      relate_issue_Jira: "Relate Jira Issue",
      ...
      import: {
        ...
        import_tip3: "Import test cases in the template format"
      },
      export: {
        export: "Export cases",
    ...
    plan: {
      ...
      input_affects_version: "Please select version",
      load_case: {
        case: "Load Case",
    ...
    home: {
      ...
      pass_case_size: "Pass Case count",
      bug_size: "Bug count",
