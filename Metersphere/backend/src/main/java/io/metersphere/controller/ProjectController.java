...
public class ProjectController {
    ...
    @PostMapping("/updatePlanIssues")
    @MsAuditLog(module = "project_project_manager", type = OperLogConstants.UPDATE, beforeEvent = "#msClass.getLogDetails(#projectId)", content = "#msClass.getLogDetails(#projectId)", msClass = ProjectService.class)
    public void updatePlanIssues(@RequestBody ProjectRequest request) {
        projectService.updatePlanIssues(request.getProjectId());
    }
