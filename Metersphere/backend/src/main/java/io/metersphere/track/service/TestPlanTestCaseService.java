...
public class TestPlanTestCaseService {
    ...
    public List<TestPlanCaseDTO> list(QueryTestPlanCaseRequest request) {
        ...
        List<OrderRequest> orderRequests = request.getOrders();
        for(OrderRequest orderRequest: orderRequests){
            if(orderRequest.getName().equals("issues_content")){
                OrderRequest order = new OrderRequest();
                order.setName("issues_count");
    ...
    public List<String> getTestPlanIssues(String planId) {
        return extTestPlanTestCaseMapper.getTestPlanIssues(planId);
    }
