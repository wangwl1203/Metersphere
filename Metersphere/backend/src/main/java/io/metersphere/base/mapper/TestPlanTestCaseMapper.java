...
public interface TestPlanTestCaseMapper {
    ...
    List<TestPlanTestCaseWithBLOBs> selectByExampleWithBLOBsExt(TestPlanTestCaseExample example);
    ...
    int updateIssuesInfoByPlanId(String planId);

    int updateIssuesByPlanId(TestPlanTestCaseWithBLOBs record);
}