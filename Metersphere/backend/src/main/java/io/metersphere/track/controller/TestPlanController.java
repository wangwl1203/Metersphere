...
public class TestPlanController {
    ...
    @GetMapping("/version/list/{projectId}")
    public List<JiraIssueVersions> getVersionList(@PathVariable String projectId) {
        return testPlanService.getVersionList(projectId);
    }
