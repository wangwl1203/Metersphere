...
//        Page<Object> page = PageHelper.startPage(goPage, pageSize, true);
    ...
    public List<TestCaseTestDao> getRelateTest(@PathVariable String caseId) throws IOException {
        return testCaseService.getRelateTest(caseId);
    }

    @GetMapping("/relate/auto/list/{testId}")
    public List<TestCaseTest> getRelateAutoTest(@PathVariable String testId) {
        return testCaseService.getRelateAutoTest(testId);
    }
