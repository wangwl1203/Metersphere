...
public class TrackController {
    ...
    public TrackStatisticsDTO getTrackCount(@PathVariable String projectId) {
        ...
        statistics.setP0CountStr("P0&nbsp;<br/>" + statistics.getP0CaseCountNumber());
        statistics.setP1CountStr("P1&nbsp;<br/>" + statistics.getP1CaseCountNumber());
        statistics.setP2CountStr("P2&nbsp;<br/>" + statistics.getP2CaseCountNumber());
        statistics.setP3CountStr("P3&nbsp;<br/>" + statistics.getP3CaseCountNumber());
        statistics.setP4CountStr("P4&nbsp;<br/>" + statistics.getP4CaseCountNumber());
        LogUtil.info("首页数据：" + statistics.getP4CountStr());
        return statistics;
    }
    ...
    public TrackStatisticsDTO getRelevanceCount(@PathVariable String projectId) {
        ...
        statistics.setScenarioCaseStr(Translator.get("automation_case") + "&nbsp;&nbsp;<br/><br/>" + statistics.getScenarioCaseCount());
        return statistics;
    }
